...
def update_tables():
    ...
    UpdateTables(aws_connection, aws_database_name, EXCHANGE_LIST_V2)
    UpdateTables(aws_connection, aws_database_name, EXCHANGE_LIST_V3)
    UpdateTables(aws_connection, aws_database_name, EXCHANGE_LIST_V4)
